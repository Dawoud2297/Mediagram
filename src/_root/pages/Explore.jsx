...
import { useGetPosts, useSearchPosts } from '../../lib/react-query/qAndMutations';
...
const Explore = () => {
    const {
        data: posts,
        fetchNextPage,
        hasNextPage } = useGetPosts();

    const { ref, inView } = useInView();
    const [searchValue, setSearchValue] = useState('');
    const debouncedValue = useDebounce(searchValue, 500);
    const { data: searchedPosts,
        isFetching: isSearchFetching } = useSearchPosts(debouncedValue);
    ...
    return (
        <div className="explore-container">
            ...
            <div className='flex-between w-full max-w-5xl mt-16 mb-7'>
                ...
                >
                    <p
                        className='smal-medium md:base-medium text-light-2'
                    >All
                    </p>
                    <img
            ...
            <div
                className='flex flex-wrap gap-9 w-full max-w-5xl'
            >
                {
